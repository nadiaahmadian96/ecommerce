      ...
      {loading ? (
        ...
        <>
              ...
              <ListGroup variant='flush'>
                ...
                <ListGroup.Item>
                  <Rating
                    ...
                    text={`${product.numReviews} نظر ها`}
                  />
                </ListGroup.Item>
          ...
          <Row>
            <Col md={6}>
              <h2>نظرات</h2>
              {product.reviews.length === 0 && <Message>نظری وجود ندارد</Message>}
              <ListGroup variant='flush'>
                ...
                <ListGroup.Item>
                  ...
                  {userInfo ? (
                    <Form onSubmit={submitHandler}>
                      <Form.Group controlId='rating'>
                        ...
                        >
                          ...
                          <option value='2'>2 - معمولی</option>
                          <option value='3'>3 - خوب</option>
                          <option value='4'>4 - خیلی خوب Good</option>
                    ...
                    <Message>
                    لطفا برای گذاشتن نظر اول <Link to='/login'>وارد  </Link> شوید
